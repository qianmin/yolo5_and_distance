...
class LidarImage:
    ...
    def lidar_camera_fusion(self, point_cloud_data, image_data):
        ...
        # 保存camera_uv camear_xyz
        if(self.save_count==0):
            np.savetxt('/home/qm/projects/fusion_ws/src/lidar_camera_fusion/scripts/camera_uv.txt',camera_uv,fmt='%0.8f')
            np.savetxt('/home/qm/projects/fusion_ws/src/lidar_camera_fusion/scripts/camera_xyz.txt', camera_xyz,fmt='%0.8f')
            print("saved++++++++++++++++++++++++++++++++++++++++++++++++++++++++++")
            self.save_count=1
